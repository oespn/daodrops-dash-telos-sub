...
export const CHAINS: { [chainId: number]: BasicChainInformation | ExtendedChainInformation } = {
  ...
  41: {
    ...
    name: 'Telos Testnet EVM',
    nativeCurrency: TLOS,
    blockExplorerUrls: ['https://testnet.telos.net/v2/explore'],
  },
  40: {
    urls: ['https://mainnet.telos.net/evm',
    ].filter((url) => url !== undefined),
    name: 'Telos Mainnet EVM',
    nativeCurrency: TLOS,
...
export const TelosURLS = (): string[]  => {
  return [ CHAINS[Number(40)].name, CHAINS[Number(41)].name ]; 
}
