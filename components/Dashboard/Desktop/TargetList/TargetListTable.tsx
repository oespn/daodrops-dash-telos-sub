...
import TargetListTableItem from './TargetListTableItem';
  ...
  return (
    <div className="bg-white shadow-lg rounded-sm border border-gray-200 relative z-screen">
      <header className="px-5 py-4">
        <h2 className="font-semibold text-gray-800">Accounts <span className="text-gray-400 font-medium">{total}</span></h2>
      </header>
      <div>
            ...
            <thead className="text-xs uppercase text-gray-500 bg-gray-50 border-t border-gray-200">
              <tr>
                ...
                <th className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                  <div className="font-semibold text-left">Targets</div>
                </th>
                <th className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
